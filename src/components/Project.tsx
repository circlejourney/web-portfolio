...
export default function Project ({project, setProject}: {
    ...
    return (<div className="bg-linear-to-r from-[#24506B] to-cyan-600 hover:to-cyan-900 hover:bg-linear-65 rounded-2xl p-4 shadow-lg transition-normal transition-colors duration-200 flex flex-row items-center gap-4 group">
        ...
        <h3 className="text-3xl sm:w-400">
            <a href="#" onClick={(e)=>{e.preventDefault(); setProject(project)}} className="project-link cursor-pointer">
                {project.title}
